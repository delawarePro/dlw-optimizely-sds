...
The **Embedded Sitemap Service** is a tool designed to create sitemaps for any Optimizely project. It helps **improve SEO** by generating XML sitemaps that search engines can use to index your site(s) more effectively.
...
Install the NuGet package, currently available from the Platina feed:
    ...
    Install-Package Dlw.Optimizely.Sitemap.Embedded
